...
class GetAvgUseCase extends UseCase<AvgEntity, ParamsListResult> {
  ...
  @override
  Future<Either<Failure, AvgEntity>> call(ParamsListResult params) async {
    return await avgRepository.getAvg(params.results);
  }
}
